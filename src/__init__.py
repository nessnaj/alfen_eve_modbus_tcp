...
class CarCharger(AlfenEve):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.registers = {
            # name, slave, address, length, register, type, target type, description, unit, batch
            ...
            "temperature": (0xc8, 0x44e, 2, registerType.HOLDING, registerDataType.FLOAT32, int, "Board Temperature", "degrees Celsius", 2),
            "ocpp_state": (0xc8, 0x450, 1, registerType.HOLDING, registerDataType.UINT16, int, "Back Office Connected", "", 2),
            "nr_of_sockets": (
            0xc8, 0x451, 1, registerType.HOLDING, registerDataType.UINT16, int, "Number of Sockets", "", 2)
